def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Nikita\Desktop\GreekBrains\ДОМАШКА\Backend-Flask-FastAPI\Flask_Hw1'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Nikita\Desktop\GreekBrains\ДОМАШКА\Backend-Flask-FastAPI\Seminar1\Scripts\deactivate.nu'